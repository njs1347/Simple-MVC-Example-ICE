...
//function to find all dogs on request. Express functions always receive the request and the response.
...
//function to find a specific god on request. Express functions always receive the request and the response.
var readDog = function(req, res) {
    ...
    //Call the static function attached to CatModels. This was defined in the Schema in the Model file. 
    //This is a custom static function added to the CatModel
    //Behind the scenes this runs the findOne method. You can find the findDogByName function in the model file.
...
var searchDogName = function(req,res) {
    ...
    //Call our Dog's static findDogByName function. Since this is a static function, we can just call it without an object
    //Methods like sayName are attached only to each object instance (not static) 
...
var updateLastDog = function(req, res) {
    ...
    //once you change all the object properties you want, then just call the Model object's save function
    lastAddedDog.save(function(err) {
        //if save error, just return an error for now
        if(err) {
            return res.json({err:err});
        }
